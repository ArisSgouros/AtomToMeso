...
if __name__ == "__main__":
   ...
   ComputeBond(path_lammps_data_out, [1], n_frame, path_lammps_dump_out, export_hist=True, export_hist_partial=True, lbin=0.006525, verbose=True, debug=True)
   ComputeBond(path_lammps_data_out, [2], n_frame, path_lammps_dump_out, export_hist=True, export_hist_partial=True, lbin=0.006525, verbose=True, debug=True)
   ComputeBond(path_lammps_data_out, [3], n_frame, path_lammps_dump_out, export_hist=True, export_hist_partial=True, lbin=0.006525, verbose=True, debug=True)
   ComputeBond(path_lammps_data_out, [4], n_frame, path_lammps_dump_out, export_hist=True, export_hist_partial=True, lbin=0.006525, verbose=True, debug=True)
   ComputeAngle(path_lammps_data_out, [1], n_frame, path_lammps_dump_out, export_hist=True, export_hist_partial=True, lbin=0.01, verbose=True, debug=True)
   ComputeAngle(path_lammps_data_out, [2], n_frame, path_lammps_dump_out, export_hist=True, export_hist_partial=True, lbin=0.01, verbose=True, debug=True)
   ComputeAngle(path_lammps_data_out, [3], n_frame, path_lammps_dump_out, export_hist=True, export_hist_partial=True, lbin=0.01, verbose=True, debug=True)
   ComputeAngle(path_lammps_data_out, [4], n_frame, path_lammps_dump_out, export_hist=True, export_hist_partial=True, lbin=0.01, verbose=True, debug=True)
